...
using PrototypingPlayground._1.GameDevelopmentPatterns._1.Singleton.GameManagerComponents;
using UnityEngine;
namespace PrototypingPlayground._1.GameDevelopmentPatterns._1.Singleton
{
